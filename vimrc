...
" set guifont=OpenDyslexic\ Regular:h17
...
" Remove those annoying roof characters
noremap <leader>killroofs :%s///g<cr>
" open nerd tree
...
" format as xml
noremap <leader>fxml :%!xmllint --format %<cr>
